...
class Zero123(nn.Module):
    def __init__(self, device, fp16=True, t_range=[0.02, 0.98], model_key="/media/work/E/data_aigc/cache/models--ashawkey--zero123-xl-diffusers"):
        super().__init__()
...
if __name__ == '__main__':
    ...
    # 统一使用本地模型路径
    zero123 = Zero123(device, model_key='/media/work/E/data_aigc/cache/models--ashawkey--zero123-xl-diffusers')
